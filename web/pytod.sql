...
(1,'Witam jestem uczniem który dopiero co zaczyna swoją przygode z tworzeniem stron. W szkole dostałem zadanie nad którym już siedzę tydzień i nie mam pojęcia jak sie za to zabrać. Zadanie brzmi:
"Po wejściu na strone wyświetla się input, do którego należy podać długość tablicy (wartość liczbowa) - zabezpieczyć przed wpisywaniem tekstu. Po wpisaniu prawidłowej zostanie stworzona tablica, do której zostaną przypisane losowe wartości z przedziału -100 : 100. Finalnie funkcja ma zwrócić sumę wszystkich liczb."
Prosił bym o jakąś pomoc z stworzeniem takiej aplikacji lub chociaż podpowiedziec jak się za to zabrać bo nie mam pojęcia od czego zacząć.','2019-05-29 23:18:38'),
...
(2,'Napisz program, który wyswietla 100 losowych liczb naturalnych z zakresu podanego przez
uzytkownika. Np. gdy uzytkownik poda liczby 13 i 67, to program powinien wyswietlic 100 losowych wartosci
mieszczacych sie w zakresie od 13 do 67 (włacznie).','2019-07-29 03:18:38'),
(2,'Palindrom to wyrazenie brzmiace tak samo czytane od lewej do prawej i od prawej do lewej.
Przykłady palindromów to: ”Kobyła ma mały bok.” i ”Zakopane chce na pokaz.”. Napisz program,
który pobiera od uzytkownika 2 linijki tekstu - 2 wyrazenia (bez polskich znaków) i zwraca informacje, czy
sa one wzajemnymi palindromami. Programistyczne uwagi: zauwaz, ze liczba słów/spacji nie ma znaczenia
(tylko kolejnosc liter w wyrazeniu) oraz takie same duze i małe litery sa ze soba utozsamiane. Znaki interpunkcyjne
równiez pomijamy przy ustalaniu, czy dane wyrazenie jest palindromem (jak kropka na koncu
zdania).','2019-08-29 23:18:38'),
...
(3,'Hej!
Na internecie pełno rankingów najbardziej popularnych bądź porządanych języków programowania na świecie. Ja bym chciał w tym temacie skupic się na polskiej scenie i poznać wasze top 5 najbardziej porządanych języków programowania w Polsce w 2020. W miarę możliwości proszę uzasadnijcie swoje wybory.
Z góry dzięki wielkie za wszystkie opinie! :)','2019-10-29 12:18:38');
